...
# Load datasets
mydata <- read.table(file = "dataset_Table_S12.txt",sep = "\t", header = TRUE) 
names(mydata)
str(mydata)
...
trait = "Egg_HR_size_MAX_plant" # use this to analyse egg-induced HR
#trait = "Wash_HR_size_MAX_plant" # use this to analyse egg wash-induced HR
...
#### Fig.1 - Phenotypic data distribution   ####
